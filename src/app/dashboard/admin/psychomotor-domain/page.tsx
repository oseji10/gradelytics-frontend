...
import PsychomotorDomainEntry from "@/components/tables/AdminPsychomotorDomain";

export const metadata: Metadata = {
   title: "Psychomotor Domain | Domain Manager",
...
export default function PsychomotorDomain() {
  return (
    <div>
