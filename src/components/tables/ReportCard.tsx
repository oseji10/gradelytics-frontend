...
>([]);
  ...
  const studentId = useSearchParams().get("studentId"); // default to "1" if not provided
...
const [reportRes, gradingRes] = await Promise.all([
  axios.get(`${process.env.NEXT_PUBLIC_API_URL}/results/student/report-card/${studentId}`, {
    withCredentials: true, // or credentials: "include" depending on your axios version
    headers: { "Content-Type": "application/json" },
  }),
  axios.get(`${process.env.NEXT_PUBLIC_API_URL}/grading-system`, {
